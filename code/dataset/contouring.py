...
def createContouredMap(height_map):
    ...
    retval, thresholded = cv.threshold(sobelMap, 65, 255, cv.THRESH_BINARY)
    ...
    cv.filterSpeckles(thresholdedPatched, 0, 10, 255)[0]
...
def main():
    ...
    folderName = r"C:/Users/tobia/BA/map-synth-ba/dataset/h_maps_fs_data/"
    destinationFolder = r"C:/Users/tobia/BA/map-synth-ba/dataset/h_maps_data/"
